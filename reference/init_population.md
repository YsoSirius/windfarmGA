...
Create `nStart` random sub-selections from the indexed grid and assign
...
- Grid:
  ...
  function, with X and Y coordinates and Grid cell IDs.
...
Returns a list of `nStart` initial individuals, each consisting of `n`
